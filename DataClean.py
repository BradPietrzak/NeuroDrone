...
def main():
    input_file_path = r"C:\Users\bradp\PycharmProjects\relearning python\BrainDroneInterface\brainData\eeg_data_UP.json"
    output_file_path = r"C:\Users\bradp\PycharmProjects\relearning python\BrainDroneInterface\brainData\merged_data_UP.json"
    print("first quarter")
    try:
